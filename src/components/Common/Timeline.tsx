...
const items: TimelineItem[] = [
  {
    ...
    ja: <>大阪で OWDDM<wbr />「Osaka Web Designers &amp; Developers Meetup」<wbr />として設立されました</>,
    icon: (
  ...
  },
  {
    ...
    ja: <>多岐にわたるイベントが開催されました。<wbr />当初はウェブデザインや開発に重点を置いていましたが、<wbr />その後、クラウド、AI、ゲーム開発といった分野にも話題が広がりました。<wbr />また、夕食会や季節のイベントなどの交流会を通じて、<wbr />強固なコミュニティを築き上げました。</>,
    icon: <img src={star.src} alt="" className="w-20" />,
  },
  {
    year: "2023",
    text: "Kyoto counterpart, KWDDM, joining this year.",
    ja: <>KWDDM は<wbr />京都のパートナー団体になりました。</>,
    icon: (
      <SafariIOSDarkdmodeBugfix
        imgSrc={kwddmLogoUrl}
        Svg={KwddmLogoSvg}
  ...
  },
  {
    ...
    ja: <>10年近くを経て、<wbr />このコミュニティは「OKTech」へと名称を変更しました。<wbr />これは、コミュニティ主導かつボランティア運営という姿勢を維持しつつ、<wbr />関西地域のテクノロジー全般に焦点を広げることを反映したものです。</>,
    icon: (
